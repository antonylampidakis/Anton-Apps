...
export const apps: PersonalApp[] = [
  ...
  {
    id: 'dapaxo-equipment',
    name: 'dapaxo-equipment',
    description: 'Εφαρμογή για  dapaxo-equipment .',
    category: 'Tools',
    status: 'Live',
    url: 'https://antonylampidakis.github.io/dapaxo-equipment/',
    technologies: ['React', 'TypeScript', 'Supabase'],
    icon: '🚒',
  },
  {
    id: 'car-management',
    name: 'car-management',
    description: 'Εφαρμογή για  car-management .',
    category: 'Tools',
    status: 'Live',
    url: 'https://car-management-indol.vercel.app/dashboard/',
    technologies: ['React', 'TypeScript', 'Supabase'],
    icon: '🚗',
  },
]
